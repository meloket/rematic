...
contract Rematic is ERC20, Ownable {
    ...
    uint256 public token1DividendRewardsFee = 8;
    uint256 public token2DividendRewardsFee = 2;
    uint256 public buybackFee = 2;
    uint256 public teamFee = 2;
    uint256 public flexFee = 0;
    uint256 public totalFees = token1DividendRewardsFee + flexFee + token2DividendRewardsFee + liquidityFee + buybackFee + teamFee;
    uint256 public gasForProcessing = 600000;

    address public teamWallet = 0x518e8044928AE2d88d33F1ecf56693B42a0023ee;
    address public flexWallet = 0x9AB1d93C27Ba186e6a7Fc1DfDAd308574027F95e;
    ...
    uint public accumulatedBuybackBNB = 0;
    ...
    event Processedtoken2DividendTracker(
        ...
        address private _newOwner = 0x7aE4BC98606AE33d3D464Cd0252Bf8bB0939DAc8;
    constructor() ERC20("Rematic", "RMTX") {
...
contract Token1DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("Rematic_Token1_Dividend_Tracker", "Rematic_Token1_Dividend_Tracker", 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7) {
    	claimWait = 3600;
...
contract Token2DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("Rematic_Token2_Dividend_Tracker", "Rematic_Token2_Dividend_Tracker", 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5_000_000_000 * (10**18); //must hold 2000000+ tokens
    }
